...
def compile_projection_step(field: str) -> str:
    ...
    if field == "_from":
        return _logical_id_projection(".outV().id()")
    if field == "_to":
        return _logical_id_projection(".inV().id()")
